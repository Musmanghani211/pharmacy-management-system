...
if(isset($_POST["add_company"]))
{
    ...
    ':company_added_datetime'   =>  date('Y-m-d H:i:s'), // or NOW() if it's acceptable in your SQL
    ':company_updated_datetime' =>  date('Y-m-d H:i:s') // or NOW() if it's acceptable in your SQL
);
                                            ...
                                            <div class="card-body">
                                                <form method="post">
                                                    ...
                                                    <div class="mt-4 mb-0">
                                                        ...
                                                        <input type="submit" name="edit_company" class="btn btn-primary" value="Update" />
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col col-md-6" align="right">
                                            <a href="company.php?action=add&code=<?php echo $object->convert_data('add'); ?>" class="btn btn-success btn-sm">Add Company</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
