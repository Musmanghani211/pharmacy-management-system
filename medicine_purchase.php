                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <div class="mt-4 mb-0">
                                            <input type="submit" name="add_medicine_purchase" class="btn btn-success" value="Purchase Now" />
                                        </div>
                                    </form>
                                </div>
                            </div>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col col-md-6" align="right">
                                            <a href="medicine_purchase.php?action=add&code=<?php echo $object->convert_data('add'); ?>" class="btn btn-success btn-sm">Medicine Purchase</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
