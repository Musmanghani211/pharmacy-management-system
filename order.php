                                ...
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <div class="mt-4 mb-0">
                                            ...
                                            <input type="submit" name="add_order" class="btn btn-success" value="Purchase Now" />
                                        </div>
                                    </form>
                                </div>
                            </div>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col col-md-6" align="right">
                                            <a href="order.php?action=add&code=<?php echo $object->convert_data('add'); ?>" class="btn btn-success btn-sm">Order Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
